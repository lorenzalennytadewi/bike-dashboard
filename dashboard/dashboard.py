...
def load_optimized_cleaned_data():
    ...
    data = pd.read_csv('https://raw.githubusercontent.com/lorenzalennytadewi/bike-dashboard/refs/heads/main/dashboard/main_data.csv', usecols=['dteday', 'season_x', 'registered_x', 'casual_x', 'cnt_x'], dtype=dtype_mapping)
